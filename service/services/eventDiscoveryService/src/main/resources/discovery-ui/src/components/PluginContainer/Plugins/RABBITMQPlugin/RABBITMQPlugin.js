...
const RABBITMQPlugin = (props) => {
    ...
    // This is just rendering the header of the page "RABBITMQ PLUGIN Runtime Discovery"
	const renderHeader = () => {
			...
			<div className="plugin">
				<form className="discovery-form"
                    ...
                    <div className="flex mt20">
						...
						<input name="brokerIdentity[clientUsername]"
							type="text"
							ref={register({required: true})}
							className="text-input-box"
							data-lpignore="true">
                    ...
                    <div className="flex mt20">
						...
						<input name="brokerIdentity[clientPassword]"
							type="password"
							ref={register({required: true})}
							className="text-input-box"
							data-lpignore="true">
